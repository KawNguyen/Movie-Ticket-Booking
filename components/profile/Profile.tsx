            ...
            <div>
              ...
              {!isEditing.name ? (
                <div className="flex justify-between items-center">
                  ...
                  <Button variant="link" className="text-white" onClick={() => onEdit("name")}>
                    Edit
                  </Button>
                </div>
              ) : (
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end space-x-2">
                    <Button onClick={() => onSave("name", profileData.name)}>Save</Button>

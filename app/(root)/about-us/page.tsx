              ...
              <SwiperSlide>
                ...
                <div className="flex items-center justify-center h-10 md:h-60 px-4">
                  <p className="text-black text-[12px] md:text-xl font-bold text-center max-w-[calc(100%-60px)] md:max-w-[calc(100%-280px)] md:mr-6">
                    Welcome to [Your Cinema Name]! At [Your Cinema Name], we
                    bring the magic of cinema closer to you. From the latest
                    Hollywood blockbusters to beloved classics, we provide a
                    seamless ticket booking experience, ensuring your movie
              ...
              <SwiperSlide>
                ...
                <div className="flex items-center justify-center h-10 md:h-60 px-4">
                  <ul className="text-black text-[12px] md:text-xl font-bold text-center max-w-[calc(100%-80px)] overflow-y-scroll md:overflow-hidden md:max-w-[calc(100%-160px)] md:space-y-2">
                    <p>
                      Latest Movie Releases: Stay updated with the hottest films
                      and exclusive premieres.
                    </p>
                    <p>
                      Exclusive Discounts: Enjoy special promotions and deals on
                      tickets and combos.
                    </p>
                    <p>
                      Flexible Booking: Select your preferred seats and
                      showtimes with ease.
                    </p>
              ...
              <SwiperSlide>
                ...
                <div className="flex items-center justify-center h-10 md:h-60 px-4">
                  <p className="text-black text-[12px] md:text-xl font-bold text-center max-w-[calc(100%-80px)] md:max-w-[calc(100%-300px)] md:mr-6">
                    At [Your Cinema Name], we believe in creating a world where
                    everyone can experience the joy of cinema. Our vision is to
                    provide a platform that not only makes ticket booking simple
                    and fast but also enhances the way people connect with
                    movies and unforgettable cinematic experiences.
                  </p>
                </div>
              </SwiperSlide>
            </Swiper>
